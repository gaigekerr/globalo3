...
lat_gmi_s, lng_gmi_s, times_s, o3_s = \
    globalo3_open.open_overpass2_specifieddomain(years, months_s, latmin_s, 
    latmax_s, lngmin_s, lngmax_s, 'O3', 'HindcastMR2')
lat_gmi_s, lng_gmi_s, times_s, no2_s = \
    globalo3_open.open_overpass2_specifieddomain(years, months_s, latmin_s, 
    latmax_s, lngmin_s, lngmax_s, 'NO2', 'HindcastMR2')
lat_gmi_s, lng_gmi_s, times_s, no_s = \
    globalo3_open.open_overpass2_specifieddomain(years, months_s, latmin_s, 
    latmax_s, lngmin_s, lngmax_s, 'NO', 'HindcastMR2')
...
lat_merra_s, lng_merra_s, t2m_s = globalo3_open.open_merra2t2m_specifieddomain(
    years, months_s, latmin_s, latmax_s, lngmin_s, lngmax_s)
# Interpolate T2m
t2m_n = globalo3_open.interpolate_merra_to_ctmresolution(lat_gmi_n, lng_gmi_n, 
    lat_merra_n, lng_merra_n, t2m_n)
t2m_s = globalo3_open.interpolate_merra_to_ctmresolution(lat_gmi_s, lng_gmi_s, 
    lat_merra_s, lng_merra_s, t2m_s)
...
#lat_edgar_s, lng_edgar_s, nox_edgar_s = \
#    globalo3_open.open_edgar_specifieddomain(years, latmin_s, latmax_s, 
#    lngmin_s, lngmax_s, 'NOx')
#nox_edgar_s[nox_edgar_s==0.0] = 1e-15
## Interpolate EDGAR 
#nox_edgar_n = globalo3_open.interpolate_edgar_to_ctmresolution(lat_gmi_n, 
#    lng_gmi_n, lat_edgar_n, lng_edgar_n, nox_edgar_n)
#nox_edgar_s = globalo3_open.interpolate_edgar_to_ctmresolution(lat_gmi_s, 
#    lng_gmi_s, lat_edgar_s, lng_edgar_s, nox_edgar_s)
